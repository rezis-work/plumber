...
<style>
	...
	.exp__tile {
		...
		background: color-mix(in srgb, var(--color-inverse-on-surface) 5%, transparent);
		border: none;
		cursor: pointer;
		color: inherit;
		font-family: inherit;
	...
	.exp__tile:hover {
		background: color-mix(in srgb, var(--color-inverse-on-surface) 10%, transparent);
	}
